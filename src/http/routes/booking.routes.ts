...
const bookingApplySchema = z.object({
  ...
  bookingAction: z.enum(['none', 'propose_slot', 'propose_options', 'confirm_slot', 'cancel_hold']),
  ...
  selectedSlotStartAt: z.string().datetime().nullable().optional(),
  selectedSlotEndAt: z.string().datetime().nullable().optional(),
  selectedSlotProviderMetadata: z.record(z.unknown()).nullable().optional(),
