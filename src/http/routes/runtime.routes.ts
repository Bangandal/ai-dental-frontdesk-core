...
import { PgRuntimeContextRepository } from '../../domain/runtime/runtimeContextRepository.js';
import { runtimeTurnInputSchema } from '../../domain/runtime/runtimeContracts.js';
import { RuntimeClinicNotFoundError, RuntimeTurnService } from '../../domain/runtime/runtimeTurnService.js';
...
async function createDefaultRuntimeTurnService(): Promise<RuntimeTurnService> {
  ...
  defaultRuntimeTurnService = new RuntimeTurnService(new PgRuntimeContextRepository(pool));
