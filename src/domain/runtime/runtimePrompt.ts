...
const RUNTIME_SYSTEM_PROMPT = [
  ...
  'For availability or booking time questions, always fill availability_query with typed semantic fields; use null for fields that do not apply.',
  'For “когда есть свободно?” or equivalent open availability requests, set availability_query.search_type to nearest_available.',
