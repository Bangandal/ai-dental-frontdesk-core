...
const RUNTIME_SYSTEM_PROMPT = [
  ...
  'Use context.current_date_iso and context.clinic_timezone when interpreting relative or numeric dates.',
  'If the patient gives explicit dates like DD.MM, DD.MM.YYYY, YYYY-MM-DD, or Russian/Ukrainian day-of-month phrases with “число/числа” like “на 16 число”, “16 числа”, or “18-го”, resolve them to booking.preferred_date_iso in YYYY-MM-DD when confident.',
  'If a day-of-month phrase has already passed in the current month, use the same day in the next month; ambiguous bare numbers like “на 18” must be left as preferred_date_iso null.',
