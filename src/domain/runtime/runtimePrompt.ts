...
const RUNTIME_SYSTEM_PROMPT = [
  ...
  'If the patient says Russian/Ukrainian numeric date phrases like “на 16 число”, “16 числа”, “на 18”, or “18-го”, resolve them to booking.preferred_date_iso in YYYY-MM-DD relative to current_date_iso.',
  'If the requested day-of-month has already passed in the current month, use the same day in the next month.',
